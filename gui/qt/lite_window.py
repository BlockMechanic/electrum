...
class MiniWindow(QDialog):
    ...
    def __init__(self, actuator, expand_callback, config):
        ...
        # Bitcredit address code
        self.address_input = QLineEdit()
        self.address_input.setPlaceholderText(_("Enter a Bitcredit address or contact"))
...
class ReceivePopup(QDialog):
    ...
    def setup(self, address):
        label = QLabel(_("Copied your Bitcredit address to the clipboard!"))
        ...
        self.setWindowTitle("Electrum - " + _("Receive Bitcredit payment"))
