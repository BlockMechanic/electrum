...
class Plugin(BasePlugin):
    ...
    def show_address(self, address):
        ...
        try:
            ...
            give_error(e)
        try:
            self.get_client().get_address('Bitcredit', address_n, True)
        except Exception, e:
            give_error(e)
        finally:
            self.handler.stop()
    ...
    def sign_transaction(self, tx, prev_tx, xpub_path):
        ...
        #try:
        signed_tx = client.sign_tx('Bitcredit', inputs, outputs)[1]
        #except Exception, e:
        #    give_error(e)
        #finally:
        self.handler.stop()
...
class TrezorWallet(BIP32_HD_Wallet):
    ...
    def sign_message(self, address, message, password):
        ...
        try:
            ...
            give_error(e)
        try:
            msg_sig = self.plugin.get_client().sign_message('Bitcredit', address_n, message)
        except Exception, e:
            give_error(e)
        finally:
    ...
    def check_proper_device(self):
        ...
        if not self.device_checked:
            ...
            device_address = self.get_client().get_address('Bitcredit', n)
